...
class MyAppUI extends React.Component {
    ...
    showNotebook() {
        if (this.props.notebook) {
            ...
            return (React.createElement("div", { id: "notebookInfo" },
    ...
    showVariables() {
        if (this.props.dfMap) {
            return (React.createElement("div", null,
                React.createElement("h5", null, "Dataframes in user's environment:"),
                Object.keys(this.props.dfMap).map((dfName) => {
                    let columnInfo = this.props.dfMap[dfName];
                    let columnElements = columnInfo.map(tuple => { return React.createElement("li", null,
                        tuple[0],
                        " ",
                        React.createElement("i", null,
                            ...
                            ")")); });
                    return (React.createElement("div", null,
                        React.createElement("b", null, dfName),
